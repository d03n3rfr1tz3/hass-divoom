...
DISPATCH_CASES = [
    (
        ...
        {"brightness": 75, "color": [250, 0, 0]},
        "show_light", (), {"color": [250, 0, 0], "brightness": 75, "power": True, "effect": None},
    ),
    (
        "light",
        {"brightness": 75, "color": [250, 0, 0], "effect": 3},
        {"brightness": 75, "color": [250, 0, 0], "effect": 3},
        "show_light", (), {"color": [250, 0, 0], "brightness": 75, "power": True, "effect": 3},
    ),
    ("on", {}, {}, "send_on", (), {}),
    ("off", {}, {}, "send_off", (), {}),
    (
    ...
    ("playstate", {"value": "next"}, {"value": "next"}, "send_playstate", (), {"value": "next"}),
    (
        "radio",
